...
RSpec.describe 'User testing', type: :feature do
  describe 'index page' do
    before(:example) do 
      @user = User.create(name: 'Zia', photo: 'https://unsplash.com/photos/F_-0BxGuVvo', bio: 'Engineer', posts_counter: 1)
      visit users_path
    end
  ...
  describe 'show page' do
    before(:example) do 
      @user = User.create(name: 'Zia', photo: 'https://unsplash.com/photos/F_-0BxGuVvo', bio: 'Engineer', posts_counter: 3)
